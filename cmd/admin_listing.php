...
class admin_listing extends base_admin
{
    ...
    public function create_schema ()
    {
        ...
        $schema_tmpl = str_replace( array( "{{CONTROLLER}}", "{{SCHEMA}}" ), array( $this->_controller_name, $schema ), $schema_tmpl );

        if ( put( PATH . "app/models/" . $this->_controller_name . "/" . $this->_controller_name . "_schema.php", $schema_tmpl ) ) {
...
';
    ...
    {
        $table_exists = mysql_query ( "SHOW TABLES LIKE \'' . DB_SUFFIX . '_' . $this->_controller_name . '\'" );
