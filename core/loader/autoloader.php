    ...
    public static function autoload($class)
    {
        ...
        if (!self::$_instance) {
            try {
                ...
                $class_schema = str_replace ( "_schema", "", $class );
                ...
                elseif ( file_exists ( PATH.'app/models/' . $class_schema . '/' . $class . '.php' ) )
                    include PATH.'app/models/' . $class_schema . '/' .  $class  . '.php';
                ...
                elseif ( file_exists ( PATH.'core/security/' . $class . '.php' ) )
                    include PATH.'core/security/' . $class . '.php';

                elseif ( file_exists ( PATH.'core/storage/' . $class . '.php' ) )
                    include PATH.'core/storage/' . $class . '.php';

                elseif ( file_exists ( PATH.'core/api/' . $class . '.php' ) )
                    include PATH.'core/api/' . $class . '.php';
