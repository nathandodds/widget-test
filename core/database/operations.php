...
class operations
{
    ...
    public function insert(array $data)
    {
        if (!!$this->_table && !!$data) {
            ...
            $logger->set('Core/Database/Operations: Insert failed - table and data were not set.')
                   ->write();
    ...
    public function update(array $data, $id)
    {
        if (!!$this->_table && !!$data) {
            ...
            $logger = new Logger('database');
            $logger->set('Core/Database/Operations: Update failed - table and data were not set.')
                   ->write();
